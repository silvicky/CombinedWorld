...
public class Noclip
{
    ...
    private static int help(CommandSourceStack source)
    {
        ...
        source.sendSuccess(()-> Component.literal("/noclip <dimension> [<target> <level>]"),false);
        source.sendSuccess(()-> Component.literal("Set noclipping weight from <dimension> to <level> (total 65536), or list all weights from <dimension>."),false);
